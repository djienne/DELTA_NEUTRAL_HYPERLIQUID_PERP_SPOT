...
requireLiveTradingTest('tests/test-spot-ubtc.js');
...
/**
 * Test spot market orders for UBTC (Bitcoin) on Hyperliquid
 */

const SYMBOL = 'UBTC';
const ORDER_SIZE_USD = 150; // $150 order for BTC

async function testUBTCSpot() {
  ...
  try {
    ...
    console.log(`  Mid price: $${midPrice.toFixed(2)}, Quantity: ${quantity.toFixed(assetInfo.szDecimals)}`);
