...
requireLiveTradingTest('tests/test-spot-purr.js');
...
async function testPURRSpot() {
  ...
  try {
    ...
    console.log(`  Mid price: $${midPrice.toFixed(6)}, Quantity: ${quantity.toFixed(assetInfo.szDecimals)}`);
    ...
    console.log(`  Mid price: $${midPriceSell.toFixed(6)}, Quantity: ${quantity.toFixed(assetInfo.szDecimals)}`);
    ...
    console.log(balance < 1 ? '✅ Position closed\n' : `⚠️  Dust remaining: ${balance}\n`);
